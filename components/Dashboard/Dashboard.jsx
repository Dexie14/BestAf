    ...
    <div>
      ...
      <section className=" ">
        ...
        >
          ...
          <h5 className="text-primary text-xl mb-3">{dashn?.terminals || "0"}</h5>
        </div>
        <div
          className="bg-white rounded-2xl py-2 px-6 w-1/4"
          style={{ boxShadow: " 0px 2px 4px 0px rgba(0, 0, 0, 0.10);" }}
        >
          ...
          <h5 className="text-primary text-xl mb-3">{dashn?.transactions || "0"}</h5>
        </div>
        <div
          className="bg-white rounded-2xl py-2 px-6 w-1/4"
          style={{ boxShadow: " 0px 2px 4px 0px rgba(0, 0, 0, 0.10);" }}
        ...
        >
          ...
          <h5 className="text-primary text-xl mb-3"> ₦{dashn?.transactionAmountForTheDay?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) || " 0.00"}</h5>
        </div>
        </section>
        <section className="flex gap-5 mt-5">
        <div
        ...
        >
          ...
          <h5 className="text-primary text-xl mb-3">₦{dashn?.approvedTransactionAmountForTheDay?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })  || " 0.00"}</h5>
        </div>
        <div
          className="bg-white rounded-2xl py-2 px-6 w-1/4"
          style={{ boxShadow: " 0px 2px 4px 0px rgba(0, 0, 0, 0.10);" }}
        >
          ...
          <h5 className="text-primary text-xl mb-3">₦{dashn?.declinedTransactionAmountForTheDay?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })  || " 0.00"}</h5>
        </div>
        <div
          className="bg-white rounded-2xl py-2 px-6 w-1/4"
          style={{ boxShadow: " 0px 2px 4px 0px rgba(0, 0, 0, 0.10);" }}
        >
          ...
          <h5 className="text-primary text-xl mb-3">{dashn?.approvedTransactionCountForTheDay  || "0"}</h5>
        </div>
        <div
          className="bg-white rounded-2xl py-2 px-6 w-1/4"
          style={{ boxShadow: " 0px 2px 4px 0px rgba(0, 0, 0, 0.10);" }}
        >
          ...
          <h5 className="text-primary text-xl mb-3">{dashn?.declinedTransactionCountForTheDay  || "0"}</h5>
        </div>
        </section>
      </section>
